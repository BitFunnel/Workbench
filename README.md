...
![alt text](blob/master/README/welcome-to-intellij-idea.png)

Select **pom.xml** and press **OK**.

![alt text](blob/master/README/intellij-open-file-or-project.png)

The project will be imported. Now set up the debug and run configurations by clicking on **Run => Edit Configurations ...**

![alt text](blob/master/README/intellij-edit-configurations.png)

The click the green **+** in the upper left corner to add a new configuration:

![alt text](blob/master/README/intellij-run-debug-configurations.png)

Select **Application**

![alt text](blob/master/README/intellij-add-new-configuration.png)
...
![alt text](blob/master/README/intellij-configuration-tab.png)
...
![alt text](blob/master/README/intellij-settings.png)
...
![alt text](blob/master/README/intellij-maven-settings.png)
